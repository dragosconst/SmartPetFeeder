...
class PetFeederTests(unittest.TestCase):
    ...
    def test_set_heating_temperature_valid_value(self):
        ...
        _ = self.app.post('/set/heating_temperature/', headers=data)
    ...
    def test_set_heating_temperature_invalid_value(self):
        ...
        data = {'heating_temperature': str(value)}
        _ = self.app.post('/set/heating_temperature/', headers=data)
        self.assertTrue(app.petFeeder.heating_temperature == inital_value)

    def test_set_feeding_limit_valid_value(self):
        value = 500
        data = {'feeding_limit': str(value)}
        _ = self.app.post('/set/feeding_limit/', headers=data)
    ...
    def test_give_water_default_value(self):
        initial_tank_level = app.petFeeder.tanks[Tanks.WATER]
        _ = self.app.get('/action/give_water/')
        self.assertTrue(app.petFeeder.tanks[Tanks.WATER] + (Tanks.WATER_DEFAULT_PORTION if initial_tank_level >= Tanks.WATER_DEFAULT_PORTION
    ...
    def test_give_water_higher_value(self):
        ...
        _ = self.app.get('/action/give_water/' + '?q= ' + str(value))
        self.assertTrue(
            app.petFeeder.tanks[Tanks.WATER] == initial_tank_level)
    ...
    def test_fill_tanks(self):
        ...
        self.assertTrue(app.petFeeder.tanks == expected_value)
